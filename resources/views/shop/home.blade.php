...
{{-- Contact Section --}}
<section class="contact-section content-border">
        ...
        <div class="info-section-contact-us1">
            <div class="info-card-contact-us1">
                ...
                <p class="info-detail-contact-us1">
                    <strong>Alamat:</strong> Jalan Tanjung Raya2 Rt/Rw.004/002, Saigon, Kec. Pontianak Tim., Kota
                    Pontianak, Kalimantan Barat 78232
                </p>
                <p class="info-detail-contact-us1">
                    <strong>Email:</strong> -
                </p>
            ...
            <div class="image-container-contact-us1">
                <img style="object-fit: fill" src="{{ asset('assets/images/toko.png') }}" alt="Singkawang Grand Mall"
                    class="info-image-contact-us1" />
            </div>
        </div>
