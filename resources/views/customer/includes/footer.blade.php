<section class="footer-section">
    ...
    <div class="footer-container">
        <div class="footer-brand">
            ...
            <p class="brand-details">Alamat: Jalan Tanjung Raya2 Rt/Rw.004/002, Saigon, Kec. Pontianak Tim., Kota
                Pontianak, Kalimantan Barat 78232</p>
            <p class="brand-details">No. Handphone / WhatsApp: +62 896 3054 1317</p>
            <p class="brand-details">Jam Buka: 07:00 - 17:20, Senin - Minggu</p>
        ...
        <div class="footer-links">
            ...
            <ul class="link-list">
                <li><a href="{{ route('customer.about') }}" class="footer-link">About Us</a></li>
            </ul>
        </div>
        <footer> </footer>
</section>
